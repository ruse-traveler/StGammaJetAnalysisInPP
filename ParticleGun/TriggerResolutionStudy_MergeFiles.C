// 'TriggerResolutionStudy_MergeFiles.C'
// Derek Anderson
// 09.25.2020
//
...
void TriggerResolutionStudy_MergeFiles(const Int_t nFiles=100, const TString filelist= "file.list", const TString outputrootfiles ="test.root") {
