// 'TriggerResolutionStudy_RunThirdMaker.C'
// Derek Anderson
// 09.27.2020
//
// Runs the 'StJetTreeThirdMaker' class.

// declare ThirdMaker class
class StJetTreeThirdMaker;



void TriggerResolutionStudy_RunThirdMaker(unsigned long nEvents=2000000000,char* outFile1="test.root",char* fName = "../RunParticleGun/et620gam_withGrid/output/wave2/kinematics_pt620h09gam_withGrid_BF8A746FC9D6BFB72F744D9988ABF182_21.MuDst.root") {
  ...
  gSystem->Load("./.sl73_gcc485/lib/libStJetTreeThirdMaker.so");
...
}  // end 'TriggerResolutionStudy_RunThirdMaker(unsigned long, char*, char*)'
