...
#include "StMuDSTMaker/COMMON/StMuMcTrack.h"  // [Derek, 05.20.2020]
#include "StMuDSTMaker/COMMON/StMuMcVertex.h"  // [Derek, 05.20.2020]
#include "StTriggerData.h"
...
Int_t StJetTreeThirdMaker::Init(){
  ...
  EvValues = new float[89]; // for event info
...
// ***************************************************************************/
  ...
  // for debugging [Derek, 09.18.2020]
  hCutDetector1_before = new TH1D("hCutDetector1_before", "before 'if (detector1)'", 5, 0., 5.);
  hCutDetector1_after  = new TH1D("hCutDetector1_after", "after 'if (detector1)'", 5, 0., 5.);
  hCutModuleHB_before  = new TH1D("hCutModuleHB_before", "before 'if (ModulehB <= 120)'", 5, 0., 5.);
  hCutModuleHB_after   = new TH1D("hCutModuleHB_after", "after 'if (ModulehB <= 120)'", 5, 0., 5.);
  hCutStatusAll_before = new TH1D("hCutStatusAll_before", "before 'if (!(statusAll == 1))'", 5, 0., 5.);
  hCutStatusAll_after  = new TH1D("hCutStatusAll_after", "after 'if (!(statusAll == 1))'", 5, 0., 5.);
  hCutEnergyHB_before  = new TH1D("hCutEnergyHB_before", "before 'if (!(EnergyhB > 0.2))'", 5, 0., 5.);
  hCutEnergyHB_after   = new TH1D("hCutEnergyHB_after", "after 'if (!(EnergyhB > 0.2))'", 5, 0., 5.);

  // for checking pi0 decays [Derek, 11.16.2020]
  hNumPi0   = new TH1D("hNumPi0", "No. of #pi^{0} per event", 60, 0., 60.);
  hNumDecay = new TH1D("hNumDecay", "No. of #pi^{0} decays successfully found per event", 60, 0., 60.);
  hNumPi0   -> Sumw2();
  hNumDecay -> Sumw2();

  // for efficiency [Derek, 12.02.2020]
  hNumBeforeVsCut = new TH1D("hNumBeforeVsCut", "No. of cluster candidates before each cut", 13, 0., 13.);
  hNumAfterVsCut  = new TH1D("hNumAfterVsCut", "No. of cluster candidates after each cut", 13, 0., 13.);
  hNumLeft[0][0]  = new TH1D("hNumLeftBefore0", "No. of events before cut 0 (BEMC exists)", 3, 0., 3.);
  hNumLeft[0][1]  = new TH1D("hNumLeftAfter0", "No. of events after cut 0 (BEMC exists)", 3, 0., 3.);
  hNumLeft[1][0]  = new TH1D("hNumLeftBefore1", "No. of cluster candidates before cut 1 (en4 > 0.5)", 3, 0., 3.);
  hNumLeft[1][1]  = new TH1D("hNumLeftAfter1", "No. of cluster candidates after cut 1 (en4 > 0.5)", 3, 0., 3.);
  hNumLeft[2][0]  = new TH1D("hNumLeftBefore2", "No. of cluster candidates before cut 2 (en4 is central strip)", 3, 0., 3.);
  hNumLeft[2][1]  = new TH1D("hNumLeftAfter2", "No. of cluster candidates after cut 2 (en4 is central strip)", 3, 0., 3.);
  hNumLeft[3][0]  = new TH1D("hNumLeftBefore3", "No. of cluster candidates before cut 3 (eta strip index is valid)", 3, 0., 3.);
  hNumLeft[3][1]  = new TH1D("hNumLeftAfter3", "No. of cluster candidates after cut 3 (eta strip index is valid)", 3, 0., 3.);
  hNumLeft[4][0]  = new TH1D("hNumLeftBefore4", "No. of cluster candidates before cut 4 (eta location)", 3, 0., 3.);
  hNumLeft[4][1]  = new TH1D("hNumLeftAfter4", "No. of cluster candidates after cut 4 (eta location)", 3, 0., 3.);
  hNumLeft[5][0]  = new TH1D("hNumLeftBefore5", "No. of cluster candidates before cut 5 (enp4 > 0.5)", 3, 0., 3.);
  hNumLeft[5][1]  = new TH1D("hNumLeftAfter5", "No. of cluster candidates after cut 5 (enp4 > 0.5)", 3, 0., 3.);
  hNumLeft[6][0]  = new TH1D("hNumLeftBefore6", "No. of cluster candidates before cut 6 (enp4 is central strip)", 3, 0., 3.);
  hNumLeft[6][1]  = new TH1D("hNumLeftAfter6", "No. of cluster candidates after cut 6 (enp4 is central strip)", 3, 0., 3.);
  hNumLeft[7][0]  = new TH1D("hNumLeftBefore7", "No. of cluster candidates before cut 7 (phi strip index is valid)", 3, 0., 3.);
  hNumLeft[7][1]  = new TH1D("hNumLeftAfter7", "No. of cluster candidates after cut 7 (phi strip index is valid)", 3, 0., 3.);
  hNumLeft[8][0]  = new TH1D("hNumLeftBefore8", "No. of cluster candidates before cut 8 (eneT0 > 6)", 3, 0., 3.);
  hNumLeft[8][1]  = new TH1D("hNumLeftAfter8", "No. of cluster candidates after cut 8 (eneT0 > 6)", 3, 0., 3.);
  hNumLeft[9][0]  = new TH1D("hNumLeftBefore9", "No. of cluster candidates before cut 9 (eta geometric cut)", 3, 0., 3.);
  hNumLeft[9][1]  = new TH1D("hNumLeftAfter9", "No. of cluster candidates after cut 9 (eta geometric cut)", 3, 0., 3.);
  hNumLeft[10][0] = new TH1D("hNumLeftBefore10", "No. of cluster candidates before cut 10 (phi geometric cut)", 3, 0., 3.);
  hNumLeft[10][1] = new TH1D("hNumLeftAfter10", "No. of cluster candidates after cut 10 (phi geometric cut)", 3, 0., 3.);
  hNumLeft[11][0] = new TH1D("hNumLeftBefore11", "No. of cluster candidates before cut 11 (several things...)", 3, 0., 3.);
  hNumLeft[11][1] = new TH1D("hNumLeftAfter11", "No. of cluster candidates after cut 11 (several things...)", 3, 0., 3.);
  hNumLeft[12][0] = new TH1D("hNumLeftBefore12", "No. of cluster candidates before filling tree", 3, 0., 3.);
  hNumLeft[12][1] = new TH1D("hNumLeftAfter12", "No. of cluster candidates after filling tree", 3, 0., 3.);
  for (UInt_t iCut = 0; iCut < 13; iCut++) {
    nLeftBeforeCut[iCut] = 0;
    nLeftAfterCut[iCut]  = 0;
  }

  // [Derek, 12.10.2020]
  hPtPi0 = new TH1D("hPtPi0", "#pi^{0} p_{T}", 100, 0., 100.);
  hPtTwr = new TH1D("hPtTwr", "tower p_{T}", 100, 0., 100.);
  hDidT  = new TH1D("hDidT", "index of leading tower", 4802, -1., 4801.);
  hDidE  = new TH1D("hDidE", "index of central eta strip", 18002, -1., 18001.);
  hPtPi0 -> Sumw2();
  hPtTwr -> Sumw2();
  hDidT  -> Sumw2();
  hDidE  -> Sumw2();
  ...
  _tMcMatch = new TTree("McTracksForMatching", "a tree for MC tracks to be used in matching calculation");
  _tMcMatch -> Branch("EventId", &_McEvtId, "EventId/I");
  _tMcMatch -> Branch("RunId", &_McRunId, "RunId/I");
  _tMcMatch -> Branch("NumTrks", &_McNtrk, "NumTrks/I");
  _tMcMatch -> Branch("MuVtxX", &_MuVx, "MuVtxX/D");
  _tMcMatch -> Branch("MuVtxY", &_MuVy, "MuVtxY/D");
  _tMcMatch -> Branch("MuVtxZ", &_MuVz, "MuVtxZ/D");
  _tMcMatch -> Branch("McVtxX", &_McVx, "McVtxX/D");
  _tMcMatch -> Branch("McVtxY", &_McVy, "McVtxY/D");
  _tMcMatch -> Branch("McVtxZ", &_McVz, "McVtxZ/D");
  _tMcMatch -> Branch("IdTrk", &_McIdTrk);
  _tMcMatch -> Branch("IdGeant", &_McIdGnt);
  _tMcMatch -> Branch("IdVx", &_McIdVx);
  _tMcMatch -> Branch("IdVxEnd", &_McIdVxEnd);
  _tMcMatch -> Branch("IntrVtx", &_McIntrVtx);
  _tMcMatch -> Branch("IsShower", &_McIsShower);
  _tMcMatch -> Branch("Charge", &_McChrg);
  _tMcMatch -> Branch("Rapidity", &_McRap);
  _tMcMatch -> Branch("Eta", &_McEta);
  _tMcMatch -> Branch("Phi", &_McPhi);
  _tMcMatch -> Branch("Px", &_McPx);
  _tMcMatch -> Branch("Py", &_McPy);
  _tMcMatch -> Branch("Pz", &_McPz);
  _tMcMatch -> Branch("Pt", &_McPt);
  _tMcMatch -> Branch("Ptot", &_McPtot);
  _tMcMatch -> Branch("Energy", &_McEne);
  _tMcMatch -> SetAutoSave(-500000000);
...
{  
  ...
  // for comparing particle- to detector-level [Derek, 11.05.2020]
  _McEvtId = -999;
  _McRunId = -999;
  _McNtrk  = -999;
  _MuVx    = -999.;
  ...
  UInt_t nPi0(0);
  UInt_t nDecayFound(0);
  cout << "\n ==================== \n"
       << "    Beginning pi0 decay hunt!"
       << endl;

  // mc track loop
  const Int_t nMcTrks = (Int_t) mMuDstMaker -> muDst() -> mcArray(1) -> GetEntries();
  for (Int_t iMcTrk = 0; iMcTrk < nMcTrks; iMcTrk++) {

    // grab pointer
    const StMuMcTrack *mcTrk = (StMuMcTrack*) mMuDstMaker -> muDst() -> mcArray(1) -> UncheckedAt(iMcTrk);
    ...
    // select pi0s [12.10.2020]
    const Bool_t isGoodId   = (idGnt == 7);
    const Bool_t isGoodChrg = (charge == 0.);
    const Bool_t isInEtaCut = (TMath::Abs(eta) < 0.9);
    const Bool_t isInPtCut  = (pT > 6.);
    if (isGoodId && isGoodChrg && isInEtaCut && isInPtCut) {
      hPtPi0 -> Fill(pT);
    }

    // photon hunter [11.15.2020]
    if ((idGnt == 7) && (pT > 0.)) {
      // print out pi0 info
      Int_t    decayVx = idVxEnd;
      Double_t invMass = TMath::Sqrt((energy * energy) - ((pZ * pZ) + (pY * pY) + (pX * pX)));
      cout << "Pi0! Trk[" << iMcTrk << "]: pid = " << idGnt << ", vtx = " << idVx << ", int = " << intrVtx << ", end = " << idVxEnd << ", pT = " << pT << "\n"
           << "                 (pX, pY, pZ, e) = (" << pX << ", " << pY << ", " << pZ << ", " << energy << "), m = " << invMass
           << endl;
      ++nPi0;

      // hunt for decay products
      Double_t eSum(0);
      Double_t pXsum(0);
      Double_t pYsum(0);
      Double_t pZsum(0);
      for (UInt_t iMcPi0 = 0; iMcPi0 < nMcTrks; iMcPi0++) {
        const StMuMcTrack *mcPi0 = (StMuMcTrack*) mMuDstMaker -> muDst() -> mcArray(1) -> UncheckedAt(iMcPi0);

        Int_t    pi0vx = mcPi0 -> IdVx();
        Double_t pTpi0 = mcPi0 -> pT();
        if (iMcPi0 == iMcTrk) continue;
        if (pi0vx != decayVx) continue;

        Int_t    idPi0  = mcPi0 -> GePid();
        Int_t    endPi0 = mcPi0 -> IdVxEnd();
        Int_t    intPi0 = mcPi0 -> ItrmdVertex();
        Double_t pXpi0  = mcPi0 -> Pxyz().x();
        Double_t pYpi0  = mcPi0 -> Pxyz().y();
        Double_t pZpi0  = mcPi0 -> Pxyz().z();
        Double_t ePi0   = mcPi0 -> E();
        Double_t mPi0   = TMath::Sqrt((energy * energy) - ((pZpi0 * pZpi0) + (pYpi0 * pYpi0) + (pXpi0 * pXpi0)));
        cout << "  ---> Decay Particle? Trk[" << iMcPi0 << "]: pid = " << idPi0 << ", vtx = " << pi0vx << ", int = " << intPi0 << ", end = " << endPi0 << ", pT = " << pT << "\n"
             << "                                (pX, pY, pZ, e) = (" << pXpi0 << ", " << pYpi0 << ", " << pZpi0 << ", " << ePi0 << "), m = " << mPi0
             << endl;
        eSum  += ePi0;
        pXsum += pXpi0;
        pYsum += pYpi0;
      ...
      Double_t mTot = TMath::Sqrt((eSum * eSum) - ((pZsum * pZsum) + (pYsum * pYsum) + (pXsum * pXsum)));
      Double_t mDif = mTot - invMass;
      cout << "  ---> Total inv. mass = " << mTot << ", mass(decay) - mass(pi0) = " << mDif << endl;
      if (TMath::Abs(mDif) < 0.05) {
        cout << "       Masses match!" << endl;
        ++nDecayFound;
      }
      else {
        cout << "       Masses don't match!" << endl;
      }
    }  // end pi0 condition
  ...
  hNumPi0   -> Fill(nPi0);
  hNumDecay -> Fill(nDecayFound);
  cout << "    Pi0 hunt finished!\n"
       << "      nPi0        = " << nPi0 << "\n"
       << "      nDecayFound = " << nDecayFound << "\n"
       << " ==================== \n"
       << endl;

  // get mc vertex
  const StMuMcVertex *mcVtx = (StMuMcVertex*) mMuDstMaker -> muDst() -> mcArray(0) -> UncheckedAt(0);
  const Double_t     mcVx   = mcVtx -> XyzV().x();
  const Double_t     mcVy   = mcVtx -> XyzV().y();
  const Double_t     mcVz   = mcVtx -> XyzV().z();

  // mc event info
  _McEvtId = muEvent -> eventId();
  _McRunId = muEvent -> runId();
  _McNtrk  = nMcTrks;
  _MuVx    = mMuDstMaker -> muDst() -> primaryVertex(0) -> position().x();
  _MuVy    = mMuDstMaker -> muDst() -> primaryVertex(0) -> position().y();
  _MuVz    = mMuDstMaker -> muDst() -> primaryVertex(0) -> position().z();
  _McVx    = mcVx;
  _McVy    = mcVy;
  _McVz    = mcVz;
  ...
  float z(0),YY(0),XX(0);int NOP(0),evt(0), runId(0);
   ...
   //--------------------------------------------------------------------------------------------
    ...
    //double vpdz(0);  // QUICK FIX [Derek, 09.10.2020]
    //vpdz =tofHeader->vpdVz(0);  // QUICK FIX [Derek, 09.10.2020]
    ...
    */
		...
		for (int g = 0; g < 86; g++){ EvValues[g] = -2000; }		
...
// ***************************************************************************/
		...
		*/
		...
		//EvValues[6]   = vpdz;  // QUICK FIX, [Derek, 09.10.2020]
		EvValues[6]   = 0.;
		EvValues[7]   = XX;
		EvValues[8]   = YY;
		EvValues[9]   = z;
		...
		int Iu3(0);    for (Iu3 = 1;Iu3 <=4800;Iu3++) { mStatusT[Iu3-1] = runst2[0].Status[Iu3-1];}
		 ...
		 StEmcCollection* emcCollection = mStEvent->emcCollection();    if(!emcCollection)//return kStOK;
										  {
										    cout<<"WARNING: There is no emcCollection"<<endl;      
										    return kStWarn;}
		...
		StEmcDetector* detector1 = emcCollection->detector(kBarrelEmcTowerId);
                if (!detector1) {
		  cout<<"WARNING: There is no kBarrelEmcTowerId Detector"<<endl; 
		  return kStWarn;
                }
 
                hCutDetector1_before -> Fill(1.5);
		if(detector1){   // detector1
                  hCutDetector1_after -> Fill(1.5);
		  int twr_counter =0;
		 ...
		 for(UInt_t mw1A=1;mw1A<=120;mw1A++)   
		   {   
		     ...
		     StSPtrVecEmcRawHit& hitsEw1A=module->hits(); 
                     ...
                     cout << "  hitsEw1A.size() = " << hitsEw1A.size() << endl;
			 ...
			 UInt_t   ModulehB=hitsEw1A[rw1A]->module(); 
			   UInt_t EtahB=hitsEw1A[rw1A]->eta();
                           hCutModuleHB_before -> Fill(1.5);
			   if(abs(ModulehB)<=120 && abs(EtahB) <=20 && SubhB<=2) 
			     {
                               hCutModuleHB_after -> Fill(1.5);
			       Int_t IdhB(0);
...
// ***************************************************************************/
				 ...
				 for(int i=0; i < vec_matchTrkIndex.size();i++)
			       ...
			       twr_counter++;
                               ...
                               // [Derek, 12.10.2020]
                               const Bool_t isInTwrEtaCut = (TMath::Abs(eThB) < 0.9);
                               const Bool_t isInTwrEneCut = (EnergyhB > 0.);
                               if (isInTwrEtaCut && isInTwrEneCut) {
                                 hPtTwr -> Fill(TMath::Sqrt((Twr_px * Twr_px) + (Twr_py * Twr_py)));
                               }
 ...
 //high tower
    ...
    //cout<<"::PPTPC::"<<PPTPC<<"::pidh::"<<pidh<<"::status is::"<<hu<<"::pedh is::"<<hped<<"::hRMS is::"<<hRMS<<endl;
		...
		float e_en1(0), e_en2(0), e_en3(0), e_en4(0), e_en5(0), e_en6(0),e_en7(0),e_en8(0),e_en9(0), e_en10(0),e_en11(0),e_en12(0),e_en13(0),e_en14(0),e_en15(0), e_didE(0);
                ...
                Float_t e_EtspAlt(0.);
                Float_t e_EClustSecondTwrEnergy(0);
                UInt_t  e_EClustNumTwrIncluded(0);
                Int_t   e_EClustSecondTwrIndex(0);

                // new output branches [Derek, 01.12.2021]
                Int_t e_EEstrpModuleE(0);
                Int_t e_EPstripModuleP(0);
                Int_t e_EClustSecondTwrModule(0);

                 // for efficiency [Derek, 12.02.2020]
                 hNumLeft[0][0] -> Fill(1.5);
                 nLeftBeforeCut[0]++;
		 ...
		 if (!detector)   {cout<<"There is no kBarrelEmcTowerId Detector"<<endl; return kStWarn;}
                 ...
                 // for efficiency [Derek, 12.02.2020]
                 hNumLeft[0][1] -> Fill(1.5);
                 nLeftAfterCut[0]++;

                 // loop to determine central eta strip 
		 for(UInt_t m=1;m<=120;m++) /* hello*/   {  StEmcModule* moduleE = detector->module(m);   StSPtrVecEmcRawHit& hitsE=moduleE->hits(); 
		   ...
		   for(unsigned int r=0;r<hitsE.size();r++) if(hitsE[r])
								...
								eta4=hitsE[r]->eta(); en4=mEnergyE[eta4-1];
                                                                ...
                                                                // for efficiency [Derek, 12.02.2020]
                                                                hNumLeft[1][0] -> Fill(1.5);
                                                                nLeftBeforeCut[1]++;

                                                                // [ThirdMaker Cut 1] cut on eta strip energy
								if(!(en4>=0.5)) continue;

                                                                // for efficiency [Derek, 12.02.2020]
                                                                hNumLeft[1][1] -> Fill(1.5);
                                                                nLeftAfterCut[1]++;

                                                                // assign neighboring eta strips
								...
								if(eta4+11<150)  en16=mEnergyE[eta4+11];else en16=0;if(eta4-13>=0)    en08=mEnergyE[eta4-13];else en08=0;
                                                                ...
                                                                // for efficiency [Derek, 12.02.2020]
                                                                hNumLeft[2][0] -> Fill(1.5);
                                                                nLeftBeforeCut[2]++;

                                                                // [ThirdMaker Cut 2] cut to make sure central eta strip is the central strip
								...
								did3=didE-1;  did5=didE+1; did2=didE-2;  did6=didE+2; did1=didE-3; did7=didE+3;//Int_t did0=didE-4; Int_t did8=didE+4;
                                                                ...
                                                                // for efficiency [Derek, 12.02.2020]
                                                                hNumLeft[3][0] -> Fill(1.5);
                                                                nLeftBeforeCut[3]++;
 
                                                                // [ThirdMaker Cut 3] cut on strip indices: central strip shouldn't be on edge of EMC
								if(!(did3>0 && did5<=18000&&did2>0 && did6<=18000&&did1>0 && did7<=18000)) continue;

                                                                // for efficiency [Derek, 12.02.2020]
                                                                hNumLeft[3][1] -> Fill(1.5);
                                                                nLeftAfterCut[3]++;
...
// loop to determine central phi strip																		 
    ...
    for(UInt_t x=0;x<hits2.size();x++) if(hits2[x])
					 { Int_t didP(0); float PHIP(0),ETAP(0),x2(0),y2(0),z2(0), enerP(0);UInt_t modP(0), eP(0),adcP1(0); Int_t sP(0);
					   ...
					   enp4=mEnergyP[eP4-1][sP4-1];
                                           ...
                                           // for efficiency [Derek, 12.02.2020]
                                           hNumLeft[4][0] -> Fill(1.5);
                                           nLeftBeforeCut[4]++;

                                           // [ThirdMaker Cut 4] cut on phi strip location relative to eta strip: should be within 1 tower away
					   if(!( eE<=(ETAP+0.05) && eE>=(ETAP-0.05))) continue; 

                                           // for efficiency [Derek, 12.02.2020]
                                           hNumLeft[4][1] -> Fill(1.5);
                                           hNumLeft[5][0] -> Fill(1.5);
                                           nLeftBeforeCut[5]++;
                                           nLeftAfterCut[4]++;


                                           // [ThirdMaker Cut 5] cut on central phi strip energy
					   if(!(enp4>=0.5))continue;

                                           // for efficiency [Derek, 12.02.2020]
                                           hNumLeft[5][1] -> Fill(1.5);
                                           nLeftAfterCut[5]++;
 

                                           // assign neighboring phi strips
					   if(sP4<15 && eP4>=1 && eP4<=10)   enp5=mEnergyP[eP4-1][sP4];   else enp5=0; if((sP4-2)>=0 && eP4>=1 && eP4<=10)  enp3=mEnergyP[eP4-1][sP4-2]; else enp3=0;
                                   ...
                                   // for efficiency [Derek, 12.02.2020]
                                   hNumLeft[6][0] -> Fill(1.5);
                                   nLeftBeforeCut[6]++;

                                   // [ThirdMaker Cut 6] 2nd cut on central phi strip energy!
                                   ...
                                   // for efficiency [Derek, 12.02.2020]
                                   hNumLeft[7][0] -> Fill(1.5);
                                   nLeftBeforeCut[7]++;

                                   // [ThirdMaker Cut 7] cut on strip indices: central strip shouldn't be on edge of module
                                   if(!(didP3>0 && didP5<=18000&&didP2x>0 && didP6<=18000&&didP1>0 && didP7<=18000)) continue;

                                   // for efficiency [Derek, 12.02.2020]
                                   hNumLeft[7][1] -> Fill(1.5);
                                   nLeftAfterCut[7]++;
...
//
                                       ...
                                       // loop to determine leading tower
                                       cout << "I am before being inside 0...." << endl;
                                                               ...
                                                               cout<<"  .....I am inside 0......"<<endl;
                                                               for(unsigned int k=0;k<hits.size();k++) {

                                                                 // for efficiency [Derek, 12.02.2020]
                                                                 hNumLeft[8][0] -> Fill(1.5);
                                                                 nLeftBeforeCut[8]++;

                                                                 // [ThirdMaker Cut 8] cut on tower energy!
                                                                 eneT0=hits[k]->energy(); if(!(eneT0 >=6)) continue;

                                                                 // for efficiency [Derek, 12.02.2020]
                                                                 hNumLeft[8][1] -> Fill(1.5);
                                                                 nLeftAfterCut[8]++;

																																			   cout<<"  .....I am inside 1......"<<endl;   																									 
												sT=abs(hits[k]->sub());moduleT=hits[k]->module();EtaT=hits[k]->eta(); adc11=hits[k]->adc();
                                                                   ...
                                                                   // for efficiency [Derek, 12.02.2020]
                                                                   hNumLeft[9][0] -> Fill(1.5);
                                                                   nLeftBeforeCut[9]++;

                                                                   // [ThirdMaker Cuts 9] eta geometric cut: tower should contain central eta strip
                                                                   if (!(moduleE==moduleT && eE> (eT-0.025) && eE<(eT+0.025))) continue;
                                                                   //if (!(moduleE==moduleT && eE-0.0035> (eT-0.025) && eE+0.0035<(eT+0.025))) continue;

                                                                   // for efficiency [Derek, 12.02.2020]
                                                                   hNumLeft[9][1]  -> Fill(1.5);
                                                                   hNumLeft[10][0] -> Fill(1.5);
                                                                   nLeftBeforeCut[10]++;
                                                                   nLeftAfterCut[9]++;

                                                                   // [ThirdMaker Cuts 10] phi geometric cuts: tower should contain central phi strip
                                                                   if (!(modP==moduleT && PHIP< (phT+0.025) && PHIP>(phT-0.025))) continue;
                                                                   //if (!(modP==moduleT && PHIP+0.0035< (phT+0.025) && PHIP-0.0035>(phT-0.025))) continue;

                                                                   // for efficiency [Derek, 12.02.2020]
                                                                   hNumLeft[10][1] -> Fill(1.5);
                                                                   nLeftAfterCut[10]++;
					...
					int nuOfNiq(0), nextIdq(0), nextIdTq(0),NextIdq(0), NextIdTq(0); 
                                                                               ...
                                                                               // loop to determine neighboring towers
                                                                               cout << "  .....I am being inside 1.5......" << endl;
                                                                           ...
                                                                           // for efficiency [Derek, 12.02.2020]
                                                                           hNumLeft[11][0] -> Fill(1.5);
                                                                           nLeftBeforeCut[11]++;

                                                                           // [ThirdMaker Cut 11] cut on relative tower position: make sure tower is a neighboring tower
...
// assign neighboring tower info to relevant variables and add energy accordingly
...
// determine next highest energy tower
...
if(Enpq20>nextHiEq) {nextHiEq=Enpq20;nextIdq=Idpq20;NextIdq=20;}if(Ennq20>nextHiEq){ nextHiEq=Ennq20;nextIdq=Idnq20;NextIdq=-20;}
																																	      }  // end hit loop 4 (neighboring tower loop)
	 
																																	  }  // end module loop 4 (neighboring tower loop)
...
//-----------------------------------Find the nearest tower--------------------------------------- 
                                                                               ...
                                                                               // record no. of twrs in cluster, index of tower added, and its energy [Derek, 12.23.2020/01.10.2021]
                                                                               Float_t eSecondTwr(0.);
                                                                               UInt_t  nTwrsInClust(1);
                                                                               Int_t   iSecondTwr(0);
                                                                               Int_t   mSecondTwr(0);
...
// determine which tower to add (if need be) and calculate energies accordingly(?)
...
if(fabs(delta1)<=0.018&&fabs(dphi1)<=0.018) {EneT0 = eneT0; iSecondTwr = 0; mSecondTwr = 0; eSecondTwr = 0.; nTwrsInClust = 1;}   if(EneT0==0) {EneT0 = eneT0; iSecondTwr = 0; mSecondTwr = 0; eSecondTwr = 0.; nTwrsInClust = 1;}
	...
	eff=(sqrt(total))/WEN;
       float Reff(0), efftow(0), Refftow(0); Reff=1/eff; efftow=WEN/eneT0; Refftow=1/efftow;	
		...
		float TSP(0), ehB(0);
                ...
                // alternative TSP [Derek, 12.23.2020]
                Float_t TSPalt(0.);
...
//		    TSP=(eneT0/((en4+enp4)*0.783+(en3+enp3+en5+enp5)*2.21+(en2+enp2+en6+enp6)*6.26+(en1+enp1+en7+enp7)*11.51+(en0+enp0+en8+enp8)*17.73+(en01+enp01+en9+enp9)*24.78+(en02+enp02+en10+enp10)*32.57+(en03+enp03+en11+enp11)*41.05));
		...
		TSP=(eneT0/((en4+enp4)*0.783+(en3+enp3+en5+enp5)*2.21+(en2+enp2+en6+enp6)*6.26+(en1+enp1+en7+enp7)*11.51+(en0+enp0+en8+enp8)*17.73+(en01+enp01+en9+enp9)*24.78+(en02+enp02+en10+enp10)*32.57+(en03+enp03+en11+enp11)*41.05));
                ...
                // alternative TSP [Derek, 12.23.2020]
		TSPalt=(EneT0/((en4+enp4)*0.783+(en3+enp3+en5+enp5)*2.21+(en2+enp2+en6+enp6)*6.26+(en1+enp1+en7+enp7)*11.51+(en0+enp0+en8+enp8)*17.73+(en01+enp01+en9+enp9)*24.78+(en02+enp02+en10+enp10)*32.57+(en03+enp03+en11+enp11)*41.05));
		...
		e_en01= en01;   e_en02= en02;		e_en03= en03;
                ...
                // new output branches [Derek, 12.23.2020/01.10.2021]
                e_EtspAlt               = TSPalt;
                e_EClustNumTwrIncluded  = nTwrsInClust;
                e_EClustSecondTwrIndex  = iSecondTwr;
                e_EClustSecondTwrEnergy = eSecondTwr;

                // new output branches [Derek, 01.12.2021]
                e_EEstrpModuleE         = moduleE;
                e_EPstripModuleP        = modP;
                e_EClustSecondTwrModule = mSecondTwr;;

                // for efficiency [Derek, 12.02.2020]
                hNumLeft[12][0] -> Fill(1.5);
                nLeftBeforeCut[12]++;
...
// [Derek, 04.21.2017] ****************************************************************************
		...
		EvValues[78] = e_en02;
		EvValues[79] = e_en03;
                EvValues[82] = e_EtspAlt;
                EvValues[83] = e_EClustNumTwrIncluded;
                EvValues[84] = e_EClustSecondTwrIndex;
                EvValues[85] = e_EClustSecondTwrEnergy;
                EvValues[86] = e_EEstrpModuleE;
                EvValues[87] = e_EPstripModuleP;
                EvValues[88] = e_EClustSecondTwrModule;
		...
		event   -> SetEventAttributes(EvValues);
                ...
                // [Derek, 09.18.2020]  
		cout << " ====== Filling Tree ===== \n"
                     << " INFO: while filling eneT0 is " << e_eneT0 << ", TSP = " << e_TSP << ", e_en0 = " << e_en0 << "\n"
                     << "       refmult = " << muEvent->refMult() << ", Vx = " << XX << ", Vy = " << YY << ", Vz =  " << z << ", nV = " << nV << "\n"
                     << "       e_phT = " << e_phT << ", e_eT = " << e_eT << ", e_eneT0 = " << e_eneT0 << "\n"
		     << " ======== End Info ======="
                     << endl;
...
// ***********************************************************************************************/
                ...
                //break;
																																      ...
																																      }  // end hit loop 3 (leading tower loop)
																																  }  // end module loop 3 (leading tower loop)
																													  }
					 }  // end hit loop 2 (central phi strip)
  }  // end module loop 2 (central phi strip)
		      }
							      }  // end hit loop 1 (central eta strip)
		 }  // end module loop 1 (central eta strip)
...
Int_t StJetTreeThirdMaker::Finish()
{
  ...
  // for efficiency [Derek, 12.02.2020]
  hNumBeforeVsCut -> SetBinContent(0, nLeftBeforeCut[0]);
  hNumBeforeVsCut -> SetBinContent(1, nLeftBeforeCut[1]);
  hNumBeforeVsCut -> SetBinContent(2, nLeftBeforeCut[2]);
  hNumBeforeVsCut -> SetBinContent(3, nLeftBeforeCut[3]);
  hNumBeforeVsCut -> SetBinContent(4, nLeftBeforeCut[4]);
  hNumBeforeVsCut -> SetBinContent(5, nLeftBeforeCut[5]);
  hNumBeforeVsCut -> SetBinContent(6, nLeftBeforeCut[6]);
  hNumBeforeVsCut -> SetBinContent(7, nLeftBeforeCut[7]);
  hNumBeforeVsCut -> SetBinContent(8, nLeftBeforeCut[8]);
  hNumBeforeVsCut -> SetBinContent(9, nLeftBeforeCut[9]);
  hNumBeforeVsCut -> SetBinContent(10, nLeftBeforeCut[10]);
  hNumBeforeVsCut -> SetBinContent(11, nLeftBeforeCut[11]);
  hNumBeforeVsCut -> SetBinContent(12, nLeftBeforeCut[12]);
  hNumBeforeVsCut -> GetXaxis() -> SetBinLabel(0, "cut 0");
  hNumBeforeVsCut -> GetXaxis() -> SetBinLabel(1, "cut 1");
  hNumBeforeVsCut -> GetXaxis() -> SetBinLabel(2, "cut 2");
  hNumBeforeVsCut -> GetXaxis() -> SetBinLabel(3, "cut 3");
  hNumBeforeVsCut -> GetXaxis() -> SetBinLabel(4, "cut 4");
  hNumBeforeVsCut -> GetXaxis() -> SetBinLabel(5, "cut 5");
  hNumBeforeVsCut -> GetXaxis() -> SetBinLabel(6, "cut 6");
  hNumBeforeVsCut -> GetXaxis() -> SetBinLabel(7, "cut 7");
  hNumBeforeVsCut -> GetXaxis() -> SetBinLabel(8, "cut 8");
  hNumBeforeVsCut -> GetXaxis() -> SetBinLabel(9, "cut 9");
  hNumBeforeVsCut -> GetXaxis() -> SetBinLabel(10, "cut 10");
  hNumBeforeVsCut -> GetXaxis() -> SetBinLabel(11, "cut 11");
  hNumBeforeVsCut -> GetXaxis() -> SetBinLabel(12, "output");
  hNumAfterVsCut  -> SetBinContent(0, nLeftAfterCut[0]);
  hNumAfterVsCut  -> SetBinContent(1, nLeftAfterCut[1]);
  hNumAfterVsCut  -> SetBinContent(2, nLeftAfterCut[2]);
  hNumAfterVsCut  -> SetBinContent(3, nLeftAfterCut[3]);
  hNumAfterVsCut  -> SetBinContent(4, nLeftAfterCut[4]);
  hNumAfterVsCut  -> SetBinContent(5, nLeftAfterCut[5]);
  hNumAfterVsCut  -> SetBinContent(6, nLeftAfterCut[6]);
  hNumAfterVsCut  -> SetBinContent(7, nLeftAfterCut[7]);
  hNumAfterVsCut  -> SetBinContent(8, nLeftAfterCut[8]);
  hNumAfterVsCut  -> SetBinContent(9, nLeftAfterCut[9]);
  hNumAfterVsCut  -> SetBinContent(10, nLeftAfterCut[10]);
  hNumAfterVsCut  -> SetBinContent(11, nLeftAfterCut[11]);
  hNumAfterVsCut  -> SetBinContent(12, nLeftAfterCut[12]);
  hNumAfterVsCut  -> GetXaxis() -> SetBinLabel(0, "cut 0");
  hNumAfterVsCut  -> GetXaxis() -> SetBinLabel(1, "cut 1");
  hNumAfterVsCut  -> GetXaxis() -> SetBinLabel(2, "cut 2");
  hNumAfterVsCut  -> GetXaxis() -> SetBinLabel(3, "cut 3");
  hNumAfterVsCut  -> GetXaxis() -> SetBinLabel(4, "cut 4");
  hNumAfterVsCut  -> GetXaxis() -> SetBinLabel(5, "cut 5");
  hNumAfterVsCut  -> GetXaxis() -> SetBinLabel(6, "cut 6");
  hNumAfterVsCut  -> GetXaxis() -> SetBinLabel(7, "cut 7");
  hNumAfterVsCut  -> GetXaxis() -> SetBinLabel(8, "cut 8");
  hNumAfterVsCut  -> GetXaxis() -> SetBinLabel(9, "cut 9");
  hNumAfterVsCut  -> GetXaxis() -> SetBinLabel(10, "cut 10");
  hNumAfterVsCut  -> GetXaxis() -> SetBinLabel(11, "cut 11");
  hNumAfterVsCut  -> GetXaxis() -> SetBinLabel(12, "output");
