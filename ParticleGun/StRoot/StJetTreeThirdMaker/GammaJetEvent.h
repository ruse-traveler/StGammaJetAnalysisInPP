...
class GammaJetEvent:public TObject{
 ...
 private:
  ...
  Int_t    FlagEvent_TrgTrkMisMtch;  // Flaged Event to Indentify Trigger and Track (from TPC) mismatch to avoid large background
 ...
 public:
  ...
  Int_t  GetFlagEvent_TrgTrkMisMtch(){return FlagEvent_TrgTrkMisMtch;}
  ...
  // new output branches [Derek, 12.23.2020/01.10.2021]
  Float_t GetEtspAlt()               {return EtspAlt;}
  Float_t GetEClustSecondTwrEnergy() {return EClustSecondTwrEnergy;}
  UInt_t  GetEClustNumTwrIncluded()  {return EClustNumTwrIncluded;}
  Int_t   GetEClustSecondTwrIndex()  {return EClustSecondTwrIndex;}

  // new output branches [Derek, 01.12.2021]
  Int_t GetEEstrpModuleE()         {return EEstrpModuleE;}
  Int_t GetEPstripModuleP()        {return EPstripModuleP;}
  Int_t GetEClustSecondTwrModule() {return EClustSecondTwrModule;}
