...
# job parameters
Path="/star/embed/embedding/JetEmbedding2009/Jet_pp200_2009.elz17/SL11d_embed/"
MuList="pt25.mudst.files0_36.list"
GeList="pt2.geant.files0_36.list"
Prefix="pt25_35"
Label="matchWithMcInfoTEST"
Suffix=".root"
Nevnt=1000
Nfile=1
