...
*/
void bemcCalibMacro(int nEvents = 1000000,
		    const char* filelist = "pt25_35_10127009_1.MuDst.root",
		    const char* outFile1  = "pp200pt25.testWithVpdVzCut_vpdArg0.root",
		    int nFiles = 1,
		    const char* geantfile = "/star/embed/embedding/JetEmbedding2009/Jet_pp200_2009.elz17/SL11d_embed/10127009/pt25_35_10127009_1.geant.root")
{
  ...
  gSystem->Load("/star/data01/pwg/dmawxc/Embedding/Run9pp/MuDstMatching/.sl73_gcc485/lib/libStJetTreeMcMaker.so");
