// 'StGeantJetTreeMaker.utilities.h'
...
void StGeantJetTreeMaker::InitializeInputTree(TTree *tree) {
  ...
  _tFemto -> SetBranchAddress("PrimaryTrackArray.geantId", _PrimaryTrackArray_geantId, &_bPrimaryTrackArray_geantId);
  _tFemto -> SetBranchAddress("PrimaryTrackArray.pdgId", _PrimaryTrackArray_pdgId, &_bPrimaryTrackArray_pdgId);
  ...
  _tFemto -> SetBranchAddress("TowerArray.TwrMatchDphi", _TowerArray_TwrMatchDphi, &_bTowerArray_TwrMatchDphi);
  _tFemto -> SetBranchAddress("TowerArray.TwrMatchDEta", _TowerArray_TwrMatchDEta, &_bTowerArray_TwrMatchDEta);
  _tFemto -> SetBranchAddress("TowerArray.TwrMatchP", _TowerArray_TwrMatchP, &_bTowerArray_TwrMatchP);
  _tFemto -> SetBranchAddress("TowerArray.TwrMatchIndexOfTrack", _TowerArray_TwrMatchIndexOfTrack, &_bTowerArray_TwrMatchIndexOfTrack);
  ...
  _tFemto -> SetBranchAddress("TowerArray.fMatchedTracks", _TowerArray_fMatchedTracks, &_bTowerArray_fMatchedTracks);
...
void StGeantJetTreeMaker::InitializeOutputTree(TTree *tree) {
...
void StGeantJetTreeMaker::InitializeHistograms() {
...
void StGeantJetTreeMaker::PrintInfo(const UInt_t code, const UInt_t nEvts, const UInt_t iEvt) {
...
Bool_t StGeantJetTreeMaker::IsGoodRunID(const UInt_t runID) {
...
Bool_t StGeantJetTreeMaker::IsGoodEvent(const Double_t rVtx, const Double_t zVtx) {
...
Bool_t StGeantJetTreeMaker::IsGoodTrigger(const Double_t etaTrg, const Double_t eTtrg, const UInt_t idTrg) {
...
Bool_t StGeantJetTreeMaker::IsGoodTrack(const Double_t etaTrk, const Double_t pTtrk) {
...
Bool_t StGeantJetTreeMaker::IsPi0(const UInt_t idGnt) {
...
Bool_t StGeantJetTreeMaker::IsGamma(const UInt_t idGnt) {
...
Bool_t StGeantJetTreeMaker::IsHadron(const UInt_t idGnt) {
...
Long64_t StGeantJetTreeMaker::LoadTree(const Long64_t entry) {
...
Long64_t StGeantJetTreeMaker::GetEntry(const Long64_t entry) {
