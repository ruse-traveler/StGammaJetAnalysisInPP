...
#ifndef StGeantJetTreeMaker_h
#define StGeantJetTreeMaker_h
...
class StGeantJetTreeMaker {
  ...
  public:
    ...
    // ctor, dtor
    StGeantJetTreeMaker(const Bool_t batch=0, TTree *tree=0);
  ...
  ClassDef(StGeantJetTreeMaker, 1)

};

#endif
#ifdef StGeantJetTreeMaker_cxx



StGeantJetTreeMaker::StGeantJetTreeMaker(const Bool_t batch, TTree *tree) : _tFemto(0) {
...
StGeantJetTreeMaker::~StGeantJetTreeMaker() {
