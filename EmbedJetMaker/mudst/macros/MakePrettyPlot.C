...
void MakePrettyPlot() {
  ...
  const TString sDenom("input/pythia/pp200py8par.forComparison_correctBinScheme_pTbinBig.et911nTrg100Kpt021Kgam.r02a005rm1chrg.d12m3y2020.root");
  const TString sHistDenom("Gam/hJetPtCorrG");
  const TString sNameDenom("hUnweightedPy8");
  const TString sLabelDenom("unweighted Pythia8");

  // numerator parameters
  const TString sNumer[NNumer]      = {"input/weightedPythia/pp200py8par.weightedToDataSmearedWithHist911.et0100gam.r02a005rm1chrg.d23m3y2021.root", "input/weightedPythia/pp200py8par.weightedToDataSmearedWithFit911.et0100gam.r02a005rm1chrg.d23m3y2021.root", "input/weightedPythia/pp200py6par.weightedToDataSmearedWithHist911.et0100gam.r02a005rm1chrg.d26m3y2021.root", "input/weightedPythia/pp200py6par.weightedToDataSmearedWithFit911.et0100gam.r02a005rm1chrg.d26m3y2021.root"};
  const TString sHistNumer[NNumer]  = {"Gam/hJetPtCorrG", "Gam/hJetPtCorrG", "Gam/hJetPtCorrG", "Gam/hJetPtCorrG"};
  const TString sNameNumer[NNumer]  = {"hHistWeightedPy8", "hFitWeightedPy8", "hHistWeightedPy6", "hFitWeightedPy6"};
  const TString sNameRatio[NNumer]  = {"hRatioHistWeightPy8", "hRatioFitWeightPy8", "hRatioHistWeightPy6", "hRatioFitWeightPy6"};
  const TString sLabelNumer[NNumer] = {"hist.-weighted Pythia8", "fit-weighted Pythia8", "hist.-weighted Pythia6", "fit-weighted Pythia6"};
  ...
  const UInt_t  fMarDen(8);
  const UInt_t  fColNum[NNumer] = {899, 859, 849, 879};
  const UInt_t  fMarNum[NNumer] = {24, 26, 32, 25};

  // text parameters
  const TString sSys("Pythia8 vs. Pythia6, #sqrt{s} = 200 GeV");
  const TString sTrg("#gamma trig., E_{T}^{trg} #in (9, 11) GeV");
  ...
  leg -> AddEntry(hDenom, sLabelDenom.Data());
  for (UInt_t iNumer = 0; iNumer < NNumer; iNumer++) {
    leg -> AddEntry(hNumer[iNumer], sLabelNumer[iNumer]);
  }
