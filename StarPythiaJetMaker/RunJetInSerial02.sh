#!/bin/bash
# 'RunJetInSerial02.sh'
# Use this to run 'RunJet02.C' and
...
# run macro
root4star -b -l <<EOF
  .x RunJet02.C("high", $input1, ${oFile1[$nFile1]}, 0.2)
EOF
...
# run macro
root4star -b -l <<EOF
  .x RunJet02.C("high", $input2, ${oFile2[$nFile2]}, 0.2)
EOF
...
# run macro
root4star -b -l <<EOF
  .x RunJet02.C("high", $input3, ${oFile3[$nFile3]}, 0.2)
EOF
...
# run macro
root4star -b -l <<EOF
  .x RunJet02.C("high", $input4, ${oFile4[$nFile4]}, 0.2)
EOF
