...
//______Jet Input
static const Double_t Jet_R_Def = 0.2;  // [Derek, 08.28.2022]
static const Int_t Remove_N_hardest = 1;

static const Int_t Jet_type = 0;                     //           "FullJet" = 1  and "ChargedJet" = 0

// [Derek, 08.28.2022]
static const TString sInListDef("input/pp200py6et6pt47.forJetRerun_noCorruptTrees_wave1run14.list");
static const TString sOutPrefDef("test");

// [Derek, 09.14.2022]
static const TString sLumiDef("high");

void RunJet02(TString lumi=sLumiDef, TString sInList=sInListDef, TString sOutPref=sOutPrefDef, Double_t Jet_R=Jet_R_Def)  // [Derek, 08.28.2022]
{
