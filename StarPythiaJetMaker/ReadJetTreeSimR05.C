...
static const Bool_t   DoWeighting = false;  // set to true for eT smearing
static const Bool_t   DoTrgNorm   = false;
static const UInt_t   TrgID       = 111;
static const Double_t PiValue     = TMath::Pi();

// filepaths
static const TString iPathDef("input/SeptRerunPi0/pp200py6pet8merge.forJetRerun_noCorruptTrees.et6100r05pi0.d23m10y2022.root");
static const TString wPathDef("input/Weights/starPythiaWeights_usingQtHistToSmear.et911vz55tsp008pi0.d21m10y2021.root");
static const TString oPathDef("pp200py6et8merge.forJetRerun_noCorruptTreesWithEtVsPtHat_pTbinOne.et6100pi0.r05rm1chrg.d23m10y2022.root");
...
void ReadJetTreeSimR05(const Bool_t inBatchMode=false, const TString iPath=iPathDef, const TString wPath=wPathDef, const TString oPath=oPathDef) {
    ...
    if (DoTrgNorm) {
      if (DoWeighting) {
        if (i == 0) {
          ...
          cout << "CHECK: normW = " << nWeightGam << endl;
        }
      } else {
        if (i == 0)  {
          norm  = (Double_t) nTrgPi0;
