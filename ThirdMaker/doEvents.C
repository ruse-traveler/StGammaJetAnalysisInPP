...
//class StIOMaker;
//class StMuDstMaker;
void doEvents(unsigned long nEvents=500,char* outFile1,char* fName = "*") //100
{ char* flag = "";
 ...
 // gSystem->Load("StDbUtilities");
  ...
  gSystem->Load("/star/u/dmawxc/JetRecon_pp/FullJetTree/ThirdMaker/.sl64_gcc482/lib/libStThirdMaker.so");
//gSystem->Load("StPointMaker.so");
  gSystem->Load("StThirdMaker");
  ...
  TString inputDir ="";
  // "/star/u/hamed/hu/old/st_junk3_5036133_raw_1090001.event.root";
  //"/star/u/hamed/hu/old/st_physics_5097044_raw_2040001.event.root";
   //"/star/data43/reco/pedAsPhys/ReversedFullField/dev/2004/093/*.event.root";//there is no smde in
//"/star/data40/reco/production62GeV/ReversedFullField/P04id/2004/090/*.event.root"; //it was day 089
 //"/star/data43/reco/ppMinBias/FullField/P03ih/2003/141/*.event.root";//ppMinBias
//"/star/data44/reco/ppLong-1/FullField/P03ih/2003/149/*.event.root"; //pplong
 //"/star/data33/reco/ppTrans-1/FullField/P03ih/2003/135/*.event.root";//ppTrans
 // "/star/u/hamed/hu/old/file1.lis/*.event.root";
 //"/star/data08/reco/dAuMinBias/FullField/P03ih/2003/080/*.event.root";//dAuMinBias
 //"/star/data19/reco/dAuCombined/FullField/P03ih/2003/065/*.event.root";//dAuCombined
 
//"/star/data34/reco/production62GeV/ReversedFullField/P04id/2004/086/*.event.root";
//"/star/data34/reco/production62GeV/ReversedFullField/P04id/2004/090/st_zerobias_*.event.root";
    //"/star/data12/reco/dAuMinBias/FullField/P03ih/2003/025/*.event.root";
...
preEcl = new StPreEclMaker();preEcl->setPrint(printOutput);
 epc = new StEpcMaker();
  ...
  StThirdMaker* thirdMaker = new StThirdMaker("thirdMaker");
